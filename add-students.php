...
<div class="col-sm-10">
<input type="text" name="rollid" class="form-control" id="rollid" maxlength="10" required="required" autocomplete="off"<br> <p><font color="red">*</font> When issuing a student id | Enter name as AP and Index Number (Ex -:AP0001)</p>
</div>
</div>
