...
<html lang="en">
 ...
 <style>
  ...
  background-size: cover;
    ...
    <title>APOLLO+ Certificate Generator</title>
  </head>
  <body>
    <center>
      <br> <br><br>
      <h3><font color = "white">APOLLO+ Certificate Generator</h3>
      <br<h5> Save Skills - Fave Future </h5></font><br><br><br>
      <form method="post" action="">
      <div class="form-group col-sm-6">
        <input type="text" name="name" class="form-control" id="name" placeholder="Student Name">
      </div>
      <div class="form-group col-sm-6">
        <input type="text" name="occupation" class="form-control" id="organization" placeholder="Company Name">
      </div>
