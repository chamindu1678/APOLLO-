<div class="left-sidebar bg-black-300 box-shadow ">
                        <div class="sidebar-content">
                            <div class="user-info closed">
                                <img src="http://placehold.it/90/c2c2c2?text=User" alt="chamindu gimhana" class="img-circle profile-img">
                                <h6 class="title">Chamindu Gimhana</h6>
                                <small class="info">G.C.C School Admin</small>
                            </div>
                            <!-- /.user-info -->
...
<li class="has-children">
                                        <a href="#"><i class="fa fa-info-circle"></i> <span>Student Result</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
