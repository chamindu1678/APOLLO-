...
<html lang="en">
    <head>
        ...
        <title>APOLLO+ | Student Results</title>
                    ...
                    <div class="main-page">
                        ...
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-12">
								     <h2 class="title" align="center">APOLLO+ </h2>
                                    <h2 class="title" align="center">S A V E &nbsp S K I L L S &nbsp - F A V E &nbsp F U T U R E </h2>
                                </div>
                            </div>
                            <!-- /.row -->
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h3 align="center">Last Term Student Result Details</h3>
                                                    <hr />
<?php
// code Student Data
$rollid=$_POST['rollid'];
...
?>
                                    ...
                                    <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                               <a href="index.php"><font color="white">Back to Home</a></font>
                                                            </div>
                                                        </div>
